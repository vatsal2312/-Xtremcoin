...
/**
 __    __    __                                                            __           
|  \  |  \  |  \                                                          |  \          
| $$  | $$ _| $$_     ______    ______   ______ ____    _______   ______   \$$ _______  
 \$$\/  $$|   $$ \   /      \  /      \ |      \    \  /       \ /      \ |  \|       \ 
  >$$  $$  \$$$$$$  |  $$$$$$\|  $$$$$$\| $$$$$$\$$$$\|  $$$$$$$|  $$$$$$\| $$| $$$$$$$\
 /  $$$$\   | $$ __ | $$   \$$| $$    $$| $$ | $$ | $$| $$      | $$  | $$| $$| $$  | $$
|  $$ \$$\  | $$|  \| $$      | $$$$$$$$| $$ | $$ | $$| $$_____ | $$__/ $$| $$| $$  | $$
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x1Ff4CBeAB4dE09B7a53d398cc773dC6ea2585Ab8; // AAC2 Owner
       // _owner = _msgSender(); 
...
contract Xtremcoin is Context, IBEP20, Ownable {
    ...
    address public _charityWalletAddress = 0xfed9310b7f8B78e59C355a89B998A74C230964be; // AAC Charity Wallet    
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20231453 *  10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Xtremcoin";
    string private _symbol = "XTR";
    ...
    uint256 public _maxTxAmount = 202314 *  10**8;
    uint256 private numTokensSellToAddToLiquidity = 202314  * 10**8;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Router V2        
        
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Test Router V2        
...
// Bot Functions 
    ...
    function setCharityAddress(address charityAdd) external onlyOwner() {
        _charityWalletAddress = charityAdd;
    }
