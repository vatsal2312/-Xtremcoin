...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xbCceA8bf90F5dC40E359264e34576264D65AC42D; // Owner
       // _owner = _msgSender(); 
...
contract Xtremcoin is Context, IBEP20, Ownable {
    ...
    address public _charityWalletAddress = 0xd8cFd81DbD5ad19Bd162AB682AdB897BB26B0759; //  Charity Wallet    
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20231453.571 *  10**8;
    ...
    constructor () {
        ...
        // BLACKLIST
        _isBlackListedBot[address(0x1Ff4CBeAB4dE09B7a53d398cc773dC6ea2585Ab8)] = true;
        _blackListedBots.push(address(0x1Ff4CBeAB4dE09B7a53d398cc773dC6ea2585Ab8));
    }
